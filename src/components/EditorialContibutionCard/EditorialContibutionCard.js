...
import styles from "./EditorialContibutionCard.module.css"

import PostHeader from '../ProfileSectionCardHeader/ProfileSectionTopRibonHeader'
...
function EditorialContibutionCard() { 

    const PostHeaderData = {
        main:"Journal Complete Name",
        date:"2days ago"
    }
...
export default EditorialContibutionCard;
