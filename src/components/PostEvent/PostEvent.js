                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs>                        
                        <FormControl>
                            ...
                            className={this.state.mediatype==40?"range":""}
                            >
                                ...
                                <MenuItem value={30}>Video Conference-Webinar</MenuItem>
                                <MenuItem value={50}>Orientation</MenuItem>
                                <MenuItem value={60}>Celebration</MenuItem>
                                <MenuItem value={70}>Project Meeting</MenuItem>
                            </Select>
                        </FormControl>
                    </Grid>
                </Grid>
