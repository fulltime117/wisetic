...
export class PostPoll extends Component {
    constructor(props) {
        super(props);
        this.state = {
            documentType:40,
                    ...
                    <Grid item xs>
                        <FormControl>
                            ...
                            >
                                ...
                                <MenuItem value={10}>Add option 1</MenuItem>
                                <MenuItem value={10}>Add option 2</MenuItem>
                                <MenuItem value={10}>Add option 3</MenuItem>
                                <MenuItem value={10}>Add option 4</MenuItem>                                
                            </Select>
                        </FormControl>
                    </Grid>
                </Grid>
