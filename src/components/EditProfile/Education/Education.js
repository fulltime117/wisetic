...
const Experience = () => {
    ...
    // accordion expanded and unexpanded
    ...
    <React.Fragment>
        <div className="editExperience-content">
            <Typography variant="h6" style={{marginBottom:"15px"}}>
                Edit "Education and Training" Information
            </Typography>  
                            ...
                            <div className={styles.experience_row}>                                
                                <Accordion expanded={expanded === index} onChange={hanChange(index)} style={{marginBottom:"15px"}} className={styles.experience_accordion}>
                                    ...
                                    >
                                        ...
                                        <Typography variant="body2">Education and Training # {index+1}</Typography>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                        <Form.Row>
                                            <Form.Group as={Col}>
                                            ...
                                            <Form.Group as={Col} controlId="formGridPassword">
                                                <TextField id="EducationAffiliation" label="Affiliation" />
                                            </Form.Group>                        
                                        </Form.Row>  
                                        <Form.Row>
                                            <Form.Group as={Col}>
                                                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                                    ...
                                                    format="MM/dd/yyyy"
                                                    // margin="normal"
                                                    id="education-start-date-picker-inline"
                                            ...
                                            <Form.Group as={Col}>
                                                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                                    ...
                                                    format="MM/dd/yyyy"
                                                    // margin="normal"
                                                    id="education-end-date-picker-inline"
